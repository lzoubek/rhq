 ...
 * @author John Sanda
 */
public class RateMonitor3 extends RateMonitor implements Runnable {

    private static final Log log = LogFactory.getLog(RateMonitor3.class);
    ...
    private static final double MIN_READ_RATE = 2.0;

    private static final double MIN_WRITE_RATE = 50;
    ...
    public RateMonitor3(AtomicReference<RateLimiter> readPermitsRef, AtomicReference<RateLimiter> writePermitsRef) {
